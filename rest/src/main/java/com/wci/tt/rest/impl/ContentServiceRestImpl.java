...
public class ContentServiceRestImpl extends RootServiceRestImpl implements
  ...
  public void loadTerminologyRf2Snapshot(
    ...
    try {
       ...
       * TODO Re-enable once loaders are brought in
...
*/
  ...
  public void loadTerminologyRf2Full(
    ...
    try {
    authorizeApp(securityService, authToken, "load full", UserRole.ADMIN);
      ...
      for (String release : releases) {
        ...
        ReleaseInfo releaseInfo =
            ContentService.getReleaseInfo(terminology, release);
        if (releaseInfo != null) {
