...
import com.wci.tt.jpa.content.AtomSubsetJpa;
...
import com.wci.tt.jpa.content.ConceptSubsetJpa;
...
import com.wci.tt.jpa.meta.CitationJpa;
import com.wci.tt.jpa.meta.ContactInfoJpa;
...
import com.wci.tt.model.content.AtomSubset;
...
import com.wci.tt.model.content.CodeRelationship;
...
import com.wci.tt.model.content.DescriptorRelationship;
...
import com.wci.tt.model.meta.CodeVariantType;
...
import com.wci.tt.model.meta.NameVariantType;
...
import com.wci.tt.model.meta.TermTypeStyle;
import com.wci.tt.model.meta.Terminology;
import com.wci.tt.model.meta.UsageType;
 ...
 */
public class RrfLoaderAlgorithm extends ContentServiceJpa implements Algorithm {
  ...
  private void loadMrsat() throws Exception {
    ...
    while ((line = reader.readLine()) != null) {
      ...
      // In loadMrconso we skip NOCODE codes, never creating them.
        ...
        Code code = getCode(codeIdMap.get(
   ...
   * @throws Exception the exception
   */
  private void setRelationshipFields(String[] fields,
    Relationship<? extends ComponentHasAttributes, ? extends ComponentHasAttributes> relationship)
      throws Exception {
